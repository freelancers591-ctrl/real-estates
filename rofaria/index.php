...
<head>
    ...
    <link rel="stylesheet" href="../gh/shishirraven/animate-on-scroll%40v1.2/animation_utility.css">
    <link rel="icon" type="image/x-icon" href="image/logo.png">
    <title>Freeliancer's Infotech - Homepage</title>
</head>

<body>
    <!-- Header -->
    <header class="sticky-top bg-accent-primary px-5">
        <nav class="navbar">
            <div class="container-fluid ps-3 gap-3">
                                    ...
                                    <div class="col col-xl-10 mb-3">
                                        <div class="d-flex flex-column">
                                            <div class="navigation">
                                                <span class="header-text">01. Homepage</span>
                                                <img src="image/img6.png" class="img-fluid rounded-3" style="aspect-ratio: 9/5;" height="175" width="311" alt="">
                                            ...
                                            <hr>
                                            <div class="navigation">
                                                <span class="header-text">02. Properties</span>
                                                <img src="image/img5.png" class="img-fluid rounded-3" style="aspect-ratio: 9/5;" height="175" width="311" alt="">
                                            ...
                                            <hr>
                                            <div class="navigation">
                                                <span class="header-text">03. About Us</span>
                                                <img src="image/img33.png" class="img-fluid rounded-3" style="aspect-ratio: 9/5;" height="175" width="311" alt="">
                                            ...
                                            <hr>
                                            <div class="navigation">
                                                <span class="header-text">04. Services</span>
                                                <img src="image/img18.png" class="img-fluid rounded-3" style="aspect-ratio: 9/5;" height="175" width="311" alt="">
                                            ...
                                            <hr>
                                            <div class="navigation">
                                                <span class="header-text">05. Contact</span>
                                                <img src="image/img29.png" class="img-fluid rounded-3 " style="aspect-ratio: 9/5;" height="175" width="311" alt="">
                                            ...
                                            <hr>
                                            <div class="navigation">
                                                <span class="header-text">06. News</span>
                                                <img src="image/img26.png" class="img-fluid rounded-3 " style="aspect-ratio: 9/5;" height="175" width="311" alt="">
                                ...
                                <div class="d-flex flex-column gap-3 accent-primary">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex flex-row gap-2">
                                            ...
                                            <a href="404.html" class="d-flex flex-row gap-2 align-items-center tags">
                                                <i class="rtmicon rtmicon-arrow-right fs-5"></i>
                                                <span>404 Page</span>
                                            </a>
                ...
                <span>+1 (212) 555-1212</span>
                <div class="w-max-content">
                    <a href="contact.html" class="btn btn-accent-outline d-flex flex-row gap-3">
    ...
    <main>
            ...
            <div class="r-container position-relative h-100">
                <div class="position-absolute top-0 start-0 end-0 bottom-0 h-100 w-100" style="margin-top: 10rem;">
                    <div class="row row-cols-2">
                        ...
                        <div class="col-9 col-xl-10">
                            <img src="image/img21.png" class="img-fluid custom-border rounded-2 w-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="d-flex flex-column gap-5 justify-content-between scrollanimation animated fadeInLeft adr-7 h-100 padding-custom">
                    <div class="d-flex flex-column gap-2 h-100">
                        <h1 style="max-width: 700px;">Find Your Dream Property Today</h1>
                        <div class="row row-xl-cols-2 row-cols-1">
                            <div class="col col-xl-2">
                                <div class="d-flex flex-column gap-2 align-items-xl-center align-items-start">
                                    <p>We are a trusted real estate team committed to helping you buy, sell, and invest
                                        with confidence.</p>
            ...
            <div class="r-container d-flex flex-column gap-5">
                <div class="row row-cols-xl-2 row-cols-1 align-items-end">
                    <div class="col mb-3 scrollanimation animated fadeInLeft adr-7">
                        <h3>Your Trusted Real Estate Experts</h3>
                    </div>
                    <div class="col mb-3 scrollanimation animated fadeInDown adr-7">
                        <div class="d-flex flex-column gap-2 align-items-end">
                            <p class="text-end" style="max-width: 600px;">
                                With expert knowledge and personalized service, we confidently guide you through the
                                real estate market to find your perfect home.
                            </p>
                            <div class="w-max-content" style="justify-self: end;">
                                <a href="about.html" class="btn btn-accent d-flex flex-row gap-2 justify-content-center">
                                    <span>About Us</span>
                                    <i class="rtmicon rtmicon-arrow-up-right fw-bold"></i>
                                </a>
                            </div>
                        ...
                        <div class="overflow-hidden" style="object-fit: cover;">
                            <div class="position-relative h-100 overflow-hidden">
                                ...
                                <div class="position-absolute start-0 bottom-0 p-4" style="z-index: 3;">
                                    <h5 class="accent-primary m-0">What is Freeliancer's Infotech?</h5>
                                </div>
                                <img src="image/img20.png" class="img-fluid w-100" style="aspect-ratio: 6/7;" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col col-xl-3 scrollanimation animated fadeInDown adr-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="flex-row">
                            ...
                            <h4>We have 20 years of experience in the real estate market.</h4>
                        </div>
                    </div>
                            ...
                            <div class="col mb-3">
                                <div class="card-counter">
                                    <div class="d-flex justify-content-start">
                                        <span class="number fun-fact" data-target="15" data-duration="1000">0</span>
                                        <span class="fun-fact">K</span>
                                        <span class="fun-fact">+</span>
                                    </div>
                                    <h5 class="text-color-2">Setisfied Clients</h5>
                                </div>
                            </div>
                            <div class="col mb-3 scrollanimation animated fadeInRight adr-7">
                                <div class="card-counter accent">
                                    <div class="d-flex justify-content-start">
                                        <span class="number fun-fact" data-target="120" data-duration="1000">0</span>
                                        <span class="fun-fact">+</span>
                                    </div>
                                    <h5 class="text-color-2">Award Winning</h5>
                                </div>
                            </div>
                            <div class="col mb-3  scrollanimation animated fadeInLeft adr-7">
                                <div class="card-counter accent2">
                                    <div class="d-flex justify-content-start">
                                        <span class="number fun-fact" data-target="500" data-duration="1000">0</span>
                                        <span class="fun-fact">+</span>
                                    </div>
                                    <h5 class="text-color-2">Property Collection</h5>
                                </div>
                            </div>
                            <div class="col mb-3">
                                <div class="card-counter">
                                    <div class="d-flex justify-content-start">
                                        <span class="number fun-fact" data-target="200" data-duration="1000">0</span>
                                        <span class="fun-fact">+</span>
                                    </div>
                                    <h5 class="text-color-2">Industry Partners</h5>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-5">
                <div class="row row-cols-xl-2 row-cols-1 align-items-end">
                    <div class="col mb-3 scrollanimation animated fadeInLeft adr-7">
                        <h3>Real estate services customized for you</h3>
                    </div>
                    <div class="col mb-3 scrollanimation animated fadeInDown adr-7">
                        <div class="d-flex flex-column gap-2 align-items-end">
                ...
                <div class="row row-cols-xl-3 row-cols-1">
                    <div class="col mb-3">
                        <div class="card card-service">
                            ...
                            <p>Helping you sell your property quickly and at the best price with expert marketing,
                                negotiation, and closing support.</p>
                    ...
                    <div class="col mb-3">
                        <div class="card card-service">
                            ...
                            <p>Expert guidance to help you find, evaluate, and purchase the perfect property with ease
                                and confidence.</p>
                            <a href="property_details.html" class="d-flex flex-row rounded-pill gap-2 align-items-center read-more">
                                <span>Learn More</span>
                                <i class="rtmicon rtmicon-arrow-up-right" style="font-weight: 600;"></i>
                    ...
                    <div class="col mb-3">
                        <div class="card card-service">
                            <div class="d-flex flex-row gap-3 align-items-center">
                                ...
                                <h4>Property Rental Services</h4>
                            </div>
                            <p>Assisting landlords and tenants in finding the perfect rental match with seamless leasing
                ...
                <div class="row row-cols-xl-2 row-cols-1 align-items-center p-5 rounded-2 bg-black-1">
                    <div class="col col-xl-8 mb-3">
                        <h4 class="accent-primary">Uncover a Wide Range of Ways We Can Assist You.
                            Browse Through All Our Services Now!</h4>
                    </div>
        ...
        <div class="section bg-attach-cover" style="background-image: url(image/bg_feature.png);">
            <div class="r-container d-flex flex-column gap-5">
                <div class="row row-cols-xl-2 row-cols-1 align-items-end">
                    <div class="col mb-3 scrollanimation animated fadeInLeft adr-7">
                        <h3 style="max-width: 400px;">Explore Your Perfect Home</h3>
                    </div>
                    <div class="col mb-3 scrollanimation animated fadeInDown adr-7">
                        <div class="d-flex flex-column gap-2 align-items-end">
                            <div class="w-max-content" style="justify-self: end;">
                    ...
                    <div class="tab-content">
                        <div class="content active" id="feature-1">
                            <div class="d-flex flex-column h-100 position-relative">
                                ...
                                <img src="image/img3.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <a href="">
                        ...
                        <div class="content" id="feature-2">
                            <div class="d-flex flex-column h-100 position-relative">
                                ...
                                <img src="image/img17.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <a href="">
                                    <div class="d-flex flex-column gap-5 rounded-2 p-4 bg-gray-hover mx-4 black-1" style="margin-top: -105px;">
                                        <div class="d-flex flex-row justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                        ...
                        <div class="content" id="feature-3">
                            <div class="d-flex flex-column h-100 position-relative">
                                ...
                                <img src="image/img5.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <a href="">
                                    <div class="d-flex flex-column gap-5 rounded-2 p-4 bg-gray-hover mx-4 black-1" style="margin-top: -105px;">
                                        <div class="d-flex flex-row justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                        ...
                        <div class="content" id="feature-4">
                            <div class="d-flex flex-column h-100 position-relative">
                                ...
                                <img src="image/img6.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <a href="">
                                    <div class="d-flex flex-column gap-5 rounded-2 p-4 bg-gray-hover mx-4 black-1" style="margin-top: -105px;">
                                        <div class="d-flex flex-row justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                    ...
                    <div class="tabs">
                        <div class="tab active" data-tab="feature-1">
                            <div class="position-relative overflow-hidden">
                                ...
                                <img src="image/img3.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                            </div>
                        </div>
                        <div class="tab" data-tab="feature-2">
                            <div class="position-relative overflow-hidden">
                                ...
                                <img src="image/img17.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                            </div>
                        </div>
                        <div class="tab" data-tab="feature-3">
                            <div class="position-relative overflow-hidden">
                                ...
                                <img src="image/img5.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                            </div>
                        </div>
                        <div class="tab" data-tab="feature-4">
                            <div class="position-relative overflow-hidden">
                                ...
                                <img src="image/img6.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-xl-row flex-column gap-5 justify-content-between align-items-center position-relative  scrollanimation animated fadeIn adr-7">
                    ...
                    <div class="d-flex flex-column gap-5 align-items-center">
                        <div class="icon-box active position-relative">
                            ...
                            <div class="position-absolute top-0 end-0 p-1 align-items-center text-center justify-content-center rounded-pill bg-black-1" style="width: 36px; height: 36px; margin-top: -15px; margin-right: -15px;">
                                <h6 class="accent-primary m-0">1.</h6>
                            </div>
                        </div>
                        <div class="d-flex flex-column text-center">
                            <h4>Explore Properties</h4>
                            <p class="accent-color-4" style="max-width: 300px;">Browse a wide selection of properties to
                    ...
                    <div class="d-flex flex-column gap-5 align-items-center">
                        <div class="icon-box position-relative">
                            ...
                            <div class="position-absolute top-0 end-0 p-1 align-items-center text-center justify-content-center rounded-pill bg-black-1" style="width: 36px; height: 36px; margin-top: -15px; margin-right: -15px;">
                                <h6 class="accent-primary m-0">2.</h6>
                            </div>
                        </div>
                        <div class="d-flex flex-column text-center">
                            <h4>Connect with Experts</h4>
                            <p class="accent-color-4" style="max-width: 300px;">Get professional guidance from real
                                estate experts to make informed.</p>
                        </div>
                    </div>
                    <div class="d-flex flex-column gap-5 align-items-center">
                        <div class="icon-box position-relative">
                            ...
                            <div class="position-absolute top-0 end-0 p-1 align-items-center text-center justify-content-center rounded-pill bg-black-1" style="width: 36px; height: 36px; margin-top: -15px; margin-right: -15px;">
                                <h6 class="accent-primary m-0">3.</h6>
                            </div>
                        </div>
                        <div class="d-flex flex-column text-center">
                            <h4>Seal the Deal</h4>
                            <p class="accent-color-4" style="max-width: 300px;">Navigate negotiations and finalize
                                transactions smoothly</p>
                        </div>
                    </div>
                </div>
                <h4 class="text-center text-accent fst-italic  scrollanimation animated fadeInDown adr-7">EXPLORE
                    PROPERTIES, CONNECT WITH EXPERTS, AND SEAL THE
                    DEAL IS A STREAMLINED PROCESS THAT TAKES YOU
                    FROM BROWSING A VARIETY OF PROPERTIES TO RECEIVING PROFESSIONAL ADVICE</h4>
            </div>
        </div>
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-5">
                <div class="d-flex flex-column gap-2 align-items-center justify-content-center mx-auto text-center  scrollanimation animated zoomIn adr-7" style="max-width: 850px;">
                    <h3>Why they love us</h3>
                    <p>Discover the voices of our satisfied clients who have experienced firsthand the exceptional
                        service and expertise we provide in helping them find their dream homes.</p>
                </div>
                        ...
                        <div class="swiper-wrapper pt-5">
                                ...
                                <div class="card testimonial-container">
                                    <div class="position-absolute start-0 top-0 overflow-visible" style="z-index: 9999; margin-left: 4rem; margin-top: -2rem;">
                                        <div class="customer-item">
                                            <img src="image/img7.png" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column gap-3">
                                        <p>From start to finish, Royal Residence guided me through every step of the
                                            process. Their advice was invaluable, and they helped me secure a beautiful
                                            home. I couldn’t be happier!
                                        </p>
                                        <div class="d-flex flex-row gap-3 align-items-center justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                                                <h5 class="m-0 team-name">Michael Brown</h5>
                                                <div class="flex-row">
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="card testimonial-container">
                                    <div class="position-absolute start-0 top-0 overflow-visible" style="z-index: 9999; margin-left: 4rem; margin-top: -2rem;">
                                        <div class="customer-item">
                                            <img src="image/img8.png" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column gap-3">
                                        <p>The team at Royal Residence was fantastic! They provided expert guidance,
                                            answered all my questions, and made the process smooth. I’m very pleased
                                            with my new home, thanks to their support!
                                        </p>
                                        <div class="d-flex flex-row gap-3 align-items-center justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                                                <h5 class="m-0 team-name">Emily White</h5>
                                                <div class="flex-row">
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="card testimonial-container">
                                    <div class="position-absolute start-0 top-0 overflow-visible" style="z-index: 9999; margin-left: 4rem; margin-top: -2rem;">
                                        <div class="customer-item">
                                            <img src="image/img9.png" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column gap-3">
                                        <p>Royal Residence made my home-buying experience smooth and
                                            enjoyable. Their
                                            team was professional, responsive, and dedicated to helping me
                                            find the
                                            perfect property that suited my needs. I highly recommend their
                                            services!
                                        </p>
                                        <div class="d-flex flex-row gap-3 align-items-center justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                                                <h5 class="m-0 team-name">Sarah Johnson</h5>
                                                <div class="flex-row">
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                            ...
                            <div class="swiper-slide">
                                <div class="card testimonial-container">
                                    <div class="position-absolute start-0 top-0 overflow-visible" style="z-index: 9999; margin-left: 4rem; margin-top: -2rem;">
                                        <div class="customer-item">
                                            <img src="image/img10.png" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column gap-3">
                                        <p>I had a great experience with the Royal Residence team. They
                                            listened to my
                                            needs and provided excellent options. Great service and very
                                            knowledgeable!
                                        </p>
                                        <div class="d-flex flex-row gap-3 align-items-center justify-content-between">
                                            <div class="d-flex flex-column gap-2">
                                                <h5 class="m-0 team-name">John Smith</h5>
                                                <div class="flex-row">
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                                                    <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
                ...
                <div class="row row-cols-xl-2 row-cols-1">
                    <div class="col mb-3 scrollanimation animated fadeInLeft adr-7">
                        <div class="d-flex flex-column gap-5">
                            <h3 style="max-width: 400px;">Client Support Questions</h3>
                            <div class="w-max-content" style="justify-self: end;">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq1" aria-expanded="true" aria-controls="faq1">
                                            What main services does Freeliancer's Infotech offer?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="false" aria-controls="faq2">
                                            How can I start searching for properties on this website?
                                        </button>
                                    </h2>
                                    <div id="faq2" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion1">
                                        <div class="accordion-body">
                                            Simply use the search feature on the homepage to filter properties by
                                            location, price, number of rooms, and more. For personalized recommendations
                                            or further assistance, feel free to contact our team.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false" aria-controls="faq3">
                                            Can I sell my property through Freeliancer's Infotech?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" aria-expanded="false" aria-controls="faq4">
                                            Are properties available in different price ranges?
                                        </button>
                                    </h2>
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-5">
                <div class="row row-cols-xl-2 row-cols-1 align-items-end">
                    <div class="col mb-3 scrollanimation animated fadeInLeft adr-7">
                        <h3 style="max-width: 600px;">We are Freeliancer's Infotech Professional team</h3>
                    </div>
                    <div class="col mb-3 scrollanimation animated fadeInDown adr-7">
                        <div class="d-flex flex-column gap-2 align-items-end">
                            <p>We are the Freeliancer's Infotech Professional Team, committed to delivering expert real estate services
                                with integrity and a client-focused approach.</p>
                            <div class="w-max-content" style="justify-self: end;">
                ...
                <div class="tab-container">
                    <div class="tab-content">
                        <div class="content active" id="team-1">
                            <div class="d-flex flex-column h-100">
                                <img src="image/img11.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                        ...
                        <div class="content" id="team-2">
                            <div class="d-flex flex-column h-100">
                                <img src="image/img27.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <div class="d-flex flex-column gap-5 rounded-2 p-4 bg-gray-hover mx-4" style="margin-top: -105px;">
                                    <div class="d-flex flex-column gap-2">
                                        <h4>Jacob Carter</h4>
                        ...
                        <div class="content" id="team-3">
                            <div class="d-flex flex-column h-100">
                                <img src="image/img13.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <div class="d-flex flex-column gap-5 rounded-2 p-4 bg-gray-hover mx-4" style="margin-top: -105px;">
                                    <div class="d-flex flex-column gap-2">
                                        <h4>Casper Noor</h4>
                        ...
                        <div class="content" id="team-4">
                            <div class="d-flex flex-column h-100">
                                <img src="image/img14.png" class="img-fluid h-100" style="aspect-ratio: 3/2;" alt="">
                                <div class="d-flex flex-column gap-5 rounded-2 p-4 bg-gray-hover mx-4" style="margin-top: -105px;">
                                    <div class="d-flex flex-column gap-2">
                                        <h4>Emily White</h4>
                    ...
                    <div class="tabs">
                        <div class="tab active" data-tab="team-1">
                            <div class="position-relative overflow-hidden">
                                <img src="image/img11.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                        ...
                        <div class="tab" data-tab="team-2">
                            <div class="position-relative overflow-hidden">
                                <img src="image/img27.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                                <div class="position-absolute start-0 bottom-0 accent-primary p-4">
                                    <h5>Jacob Carter</h5>
                                    <span>Real Estate Consultant</span>
                                </div>
                        ...
                        <div class="tab" data-tab="team-3">
                            <div class="position-relative overflow-hidden">
                                <img src="image/img13.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                                <div class="position-absolute start-0 bottom-0 accent-primary p-4">
                                    <h5>Casper Noor</h5>
                                    <span>Investment Strategist</span>
                                </div>
                        ...
                        <div class="tab" data-tab="team-4">
                            <div class="position-relative overflow-hidden">
                                <img src="image/img14.png" class="img-fluid w-100 h-100" style="aspect-ratio: 3/2;" alt="">
                                <div class="position-absolute start-0 bottom-0 accent-primary p-4">
                                    <h5>Emily White</h5>
                                    <span>Marketing Specialist</span>
                                </div>
        ...
        <div class="section">
            <div class="r-container d-flex flex-column gap-5">
                <div class="row row-cols-xl-2 row-cols-1 align-items-end">
                    <div class="col mb-3 scrollanimation animated fadeInLeft adr-7">
                        <h3 style="max-width: 600px;">Articles Related to Aestetic Home Design</h3>
                    </div>
                    <div class="col mb-3 scrollanimation animated fadeInDown adr-7">
                        <div class="d-flex flex-column gap-2 align-items-end">
                            <div class="w-max-content" style="justify-self: end;">
                                <a href="blog.html" class="btn btn-accent-outline d-flex flex-row gap-2 justify-content-center">
                                    <span>Browse All Post</span>
                                    <i class="rtmicon rtmicon-arrow-up-right fw-bold"></i>
                                </a>
                            </div>
                        </div>
                ...
                <div class="row row-cols-xl-2 row-cols-1">
                    <div class="col mb-3">
                        <div class="card d-flex flex-column gap-4">
                            <img src="image/img6.png" alt="" class="img-fluid" style="aspect-ratio: 5/3;">
                            <a href="single_blog.html">
                                <div class="d-flex flex-column gap-2 scrollanimation animated fadeInUp adr-7">
                                    <div class="d-flex flex-row gap-3">
                                        <p class="m-0">Jan 05, 2025</p>
                                        <p class="m-0">2 min read</p>
                                    </div>
                                    <h4 class="black-1 font-1">Discover unparalleled expertise in market</h4>
                                    <p>
                                        Discover Unparalleled Expertise in the Real Estate Market, Providing In-Depth
                                        Knowledge, Strategic Insights, and Tailored Solutions to Help You Navigate Every
                                        Step of Your Property Journey with Confidence.
                                    </p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col mb-3">
                        <div class="d-flex flex-column gap-4 ps-xl-4">
                            <div class="card">
                                <div class="row row-cols-xl-2 row-cols-1">
                                    <div class="col mb-3 col-xl-5">
                                        <img src="image/img17.png" alt="" class="img-fluid h-100" style="aspect-ratio: 5/3;">
                                    </div>
                                    <div class="col mb-3 col-xl-7">
                                        <a href="single_blog.html">
                                            <div class="d-flex flex-column gap-3 scrollanimation animated fadeInRight adr-7">
                                                <div class="d-flex flex-row gap-3">
                                                    <p class="m-0">Jan 02, 2025</p>
                                                    <p class="m-0">2 min read</p>
                                                </div>
                                                <h5 class="black-1 font-1" style="max-width: 300px;">Tips for Choosing
                                                    House Paint Colors to Look Elegant and Comfortable
                                                </h5>
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="row row-cols-xl-2 row-cols-1">
                                    <div class="col mb-3 col-xl-5">
                                        <img src="image/img18.png" alt="" class="img-fluid h-100" style="aspect-ratio: 5/3;">
                                    </div>
                                    <div class="col mb-3 col-xl-7">
                                        <a href="single_blog.html">
                                            <div class="d-flex flex-column gap-3 scrollanimation animated fadeInRight adr-7">
                                                <div class="d-flex flex-row gap-3">
                                                    <p class="m-0">Feb 15, 2025</p>
                                                    <p class="m-0">3 min read</p>
                                                </div>
                                                <h5 class="black-1 font-1" style="max-width: 300px;">Modern and
                                                    Functional Minimalist Home Design Inspirations
                                                </h5>
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="row row-cols-xl-2 row-cols-1">
                                    <div class="col mb-3 col-xl-5">
                                        <img src="image/img19.png" alt="" class="img-fluid h-100" style="aspect-ratio: 5/3;">
                                    </div>
                                    <div class="col mb-3 col-xl-7">
                                        <a href="single_blog.html">
                                            <div class="d-flex flex-column gap-3 scrollanimation animated fadeInRight adr-7">
                                                <div class="d-flex flex-row gap-3">
                                                    <p class="m-0">Mar 27, 2025</p>
                                                    <p class="m-0">4 min read</p>
                                                </div>
                                                <h5 class="black-1 font-1" style="max-width: 300px;">Common Home Design
                                                    Mistakes to Avoid for a More Functional Living Space
                                                </h5>
                                            </div>
                                        </a>
                                    </div>
                ...
                <div class="col col-xl-8 mb-3">
                    <div class="d-flex flex-column gap-3 justify-content-between h-100">
                        <div class="d-flex flex-column accent-primary">
                            <p class="gray">Get Contact</p>
                            <h1 class="fw-normal">hello@domainsite.com</h1>
                        </div>
                        <img src="image/logo-footer.png" alt="" class="img-fluid" width="938">
                    </div>
                </div>
                <div class="col col-xl-4 mb-3">
                    <div class="d-flex flex-column gap-5 justify-content-between accent-primary h-100">
                        <div class="d-flex flex-row gap-5">
                            <ul class="list ps-0 gap-3 accent-color">
                                <li>
                                    <a href="" class="link active d-flex flex-row gap-3 align-items-center">
                                        Home
                                    </a>
                                </li>
                                <li>
    ...
    <script src="../gh/shishirraven/animate-on-scroll%40v1.0/oyethemes_onscroll_animation.js"></script>
</body>
